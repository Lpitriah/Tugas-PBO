...
class FrmTranslator:
    ...
    def aturKomponen(self):
        ...
        Label(mainFrame, text='Hasil inggris:').grid(row=2, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='Hasil latin:').grid(row=4, column=0,
            sticky=W, padx=5, pady=5)
    ...
    def onTranslate(self):
        ...
        hasil2 = penterjemah.translate(self.txtSumber.get(), src='id', dest='la',)
        hasil3 = penterjemah.translate(self.txtSumber.get(), src='id', dest='ko',)
       
       # Clear the previous text in txtHasil1, txtHasil2, and txtHasil3
